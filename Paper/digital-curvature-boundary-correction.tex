...
We derive the digital curvature flow by evaluating iteractively model \eqref{eq:curvature_highlighting_simplified} with a slight modification. Better results are achieved by extending the computation region. 
